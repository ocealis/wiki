...
Les logs (ou "journaux") du serveur permettent aux utilisateurs disposant de la permission appropriée de consulter l’ensemble des actions effectuées sur un serveur.
